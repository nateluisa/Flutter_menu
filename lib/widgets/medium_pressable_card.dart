...
class MediumPressableCard extends StatefulWidget {
  const MediumPressableCard({
    this.onPressed,
    required this.color,
  ...
  @override
  State<StatefulWidget> createState() => _MediumPressableCardState();
}

class _MediumPressableCardState extends State<MediumPressableCard>
